...
//         {/* Main Content */}
//         <main className="relative flex-1 p-8 bg-[#0F1629]/60 backdrop-blur-xl border-l border-[#1E253F]/60 overflow-y-auto transition-all">
//           <div className="max-w-7xl mx-auto relative z-10">
//             <Outlet />
//           </div>

//           {/* Glowing Ambient Lights */}
//           <div className="absolute -top-32 -right-40 w-[400px] h-[400px] bg-blue-600/20 blur-[130px] rounded-full pointer-events-none"></div>
//           <div className="absolute bottom-[-100px] left-[-80px] w-[350px] h-[350px] bg-indigo-600/20 blur-[120px] rounded-full pointer-events-none"></div>
//           <div className="absolute bottom-[-100px] right-[120px] w-[250px] h-[250px] bg-cyan-500/15 blur-[100px] rounded-full pointer-events-none"></div>
//         </main>
//       </div>
...
const Layout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-[#0B0C10] via-[#111827] to-[#1E2233] text-gray-200 overflow-hidden transition-all duration-300">
      {/* Sidebar - Now handles its own mobile logic */}
      <Sidebar />
      ...
      >
        ...
        <main className="relative flex-1 p-4 sm:p-6 lg:p-8 bg-[#0F1629]/60 backdrop-blur-xl border-l border-[#1E253F]/60 overflow-y-auto transition-all">
          ...
          {/* Glowing Ambient Lights - Scaled for mobile */}
